...
<head>
    ...
    <style>
        body {
            background: linear-gradient(to bottom,rgb(102, 102, 109), #ffffff);
        }
    </style>
</head>
        ...
        <table class="min-w-full text-sm text-left">
            <thead class="bg-gray-200 text-gray-700 font-semibold">
                <tr>
                    ...
                    <th class="px-4 py-3">Nama Kampus</th>
                    <th class="px-4 py-3">Alamat</th>
                    <th class="px-4 py-3">Latitude</th>
                    <th class="px-4 py-3">Longtitude</th>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition duration-150">
                    ...
                    <td class="px-4 py-3"><?= htmlspecialchars($row['latitude']) ?></td>
                    <td class="px-4 py-3"><?= htmlspecialchars($row['longtitude']) ?></td>
                ...
                <tr>
                    <td colspan="6" class="text-center px-4 py-6 text-gray-500">Tidak ada data kampus.</td>
                </tr>
                <?php endif; ?>
            </tbody>
        </table>
